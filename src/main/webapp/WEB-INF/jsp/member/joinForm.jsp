...
<script>
	...
	function checkPw(){
		$.ajax({
			url: "${pageContext.request.contextPath}/member/checkPw.do",
			type: "post",
			data: {"pw1":$("#pw1").val()},
			success: callbackPw
		})
 ...
 --%>
	...
	<div align="center">
		...
		<form action="join.do" method="post" name="joinForm"
			...
			<br /> 비밀번호: <input id="pw1" type="password" name="password" onkeyup="checkPw()"/><br />
			<br/> 비밀번호 확인: <input id="pw2" type="password" name="password2" onkeyup="checkPws()" /><br/>
